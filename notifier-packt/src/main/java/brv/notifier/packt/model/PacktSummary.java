...
public class PacktSummary implements Serializable {
	...
	/**
	 * Url which points to the free ebook landing page.
	 */
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PacktSummary other = (PacktSummary) obj;
		if (coverImage == null) {
	...
	public String toString() {
		return "PacktSummary [productId=" + productId + ", title=" + title + ", coverImage=" + coverImage + ", shopUrl="
				+ shopUrl + ", readUrl=" + readUrl + ", offerUrl=" + offerUrl + "]";
	}
